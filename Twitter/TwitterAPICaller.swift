...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "UXZyg4HSn05nCxOpglsn0iUTs", consumerSecret: "KKja1PoapXXAXULqFp1gfDUifcytfFJztWYIPm8fu1IZX1ppK7")
    var loginSuccess: (() -> ())?
